...
//import ARKit
//
////room plan with colors
//class RoomARViewController2: UIViewController {
//
...
//func attachLabel2(to entity: Entity, text: String, yOffset: Float = 0.1) {
