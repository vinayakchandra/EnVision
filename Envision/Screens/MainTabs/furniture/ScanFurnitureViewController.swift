...
final class ScanFurnitureViewController: UIViewController {
    ...
    private func setupNavigationBar() {
        ...
        scanButton.menu = scanMenu
        scanButtonForTip = scanButton
        
        let scanBtn = UIBarButtonItem(customView: scanButton)
    ...
    private func setupEmptyState() {
        ...
        tipsList.text = "• Place object on plain background\n• Ensure good, even lighting\n• Capture 40-60 photos from all angles\n• Include top, bottom, and sides"
    ...
    // MARK: - TipKit Setup
    /// Sets up the TipKit tip for the scan furniture button.
    ...
    private func setupScanFurnitureTip() {
        #if canImport(TipKit)
        if #available(iOS 17.0, *) {
            let tip = ScanFurnitureTip()
            ...
            tipObservationTask = Task { @MainActor in
                for await shouldDisplay in tip.shouldDisplayUpdates {
                    if shouldDisplay {
                        ...
                        tipView.tag = 998  // Tag for easy removal
                        ...
                        if let existingTipView = self.view.viewWithTag(998) {
