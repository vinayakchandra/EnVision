...
//        let files = isSearching ? filteredFiles : roomFiles
//        if let category = selectedCategory {
//            return files.filter { url in
//                getCategoryForRoom(url: url) == category
//            }
//        }
//        return files
//    }
//    
//    private func getCategoryForRoom(url: URL) -> RoomCategory {
//        let categoryKey = url.lastPathComponent + "_category"
//        if let categoryRawValue = UserDefaults.standard.string(forKey: categoryKey),
//           let category = RoomCategory(rawValue: categoryRawValue) {
//            return category
//        }
//        return .livingRoom // Default category
//    }
//
...
//        return displayFiles()[index.item]
//    }
//}
//
